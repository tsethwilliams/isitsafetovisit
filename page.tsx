      ...
      <div className="container">
        <div className="content-layout">
          <div className="main-content">
            ...
            {/* Booking.com CTA — placed after neighborhoods for maximum conversion */}
          ...
          <div className="sidebar">
            <div className="affiliate-box">
              ...
              <a href="https://safetywing.com/?referenceID=26484939&utm_source=26484939&utm_medium=Ambassador" className="affiliate-btn" target="_blank" rel="noopener noreferrer nofollow">Get a Quote — SafetyWing</a>
              <p className="affiliate-disclaimer">Affiliate link — we may earn a commission at no cost to you</p>
            </div>
            ...
            <div className="affiliate-box booking-sidebar-box">
              ...
              <a href={bookingUrl} target="_blank" rel="noopener noreferrer nofollow" className="affiliate-btn booking-btn">Search Hotels — Booking.com</a>
              <p className="affiliate-disclaimer">Affiliate link — we may earn a commission at no cost to you</p>
            </div>
